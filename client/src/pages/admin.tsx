                ...
                <div className="border rounded-lg overflow-hidden">
                  ...
                  <div className="bg-gray-100 py-2 border-b">
                    <div className="flex items-center">
                      ...
                      <div className="flex-1 grid gap-0 text-xs font-medium text-gray-600 uppercase tracking-wide" style={{gridTemplateColumns: '1.8fr 1fr 1fr 1fr 1fr 1fr 1.2fr 1.3fr'}}>
                        <div className="text-left pl-1">ID</div>
                        <div className="text-left pl-1">지역</div>
                        <div className="text-left pl-1">챕터</div>
                        <div className="text-left pl-1">멤버명</div>
                        <div className="text-left pl-1">산업군</div>
                        <div className="text-left pl-1">회사</div>
                        <div className="text-left pl-1">전문분야</div>
                        <div className="text-left pl-1">상태/파트너수</div>
                      </div>
                    </div>
                  </div>
                  <div className="max-h-96 overflow-y-auto">
                    {filteredActiveUsers.map((user) => (
                      <div key={user.email} className="flex items-center py-3 border-b last:border-b-0 hover:bg-gray-50">
                        ...
                        <div className="flex-1 grid gap-0 text-sm" style={{gridTemplateColumns: '1.8fr 1fr 1fr 1fr 1fr 1fr 1.2fr 1.3fr'}}>
                          <div className="font-medium truncate text-left text-ellipsis overflow-hidden pl-1" title={user.email}>{user.email}</div>
                          <div className="truncate text-left text-ellipsis overflow-hidden pl-1" title={user.region}>{user.region}</div>
                          <div className="truncate text-left text-ellipsis overflow-hidden pl-1" title={user.chapter}>{user.chapter}</div>
                          <div className="truncate text-left text-ellipsis overflow-hidden pl-1" title={user.memberName}>{user.memberName}</div>
                          <div className="truncate text-left text-ellipsis overflow-hidden pl-1" title={user.industry}>{user.industry}</div>
                          <div className="truncate text-left text-ellipsis overflow-hidden pl-1" title={user.company}>{user.company}</div>
                          <div className="truncate text-left text-ellipsis overflow-hidden pl-1" title={user.specialty}>{user.specialty}</div>
                          <div className="flex items-center text-left space-x-1 pl-1">
                  ...
                  {filteredWithdrawnUsers.map((user) => (
                    <div key={user.email} className="flex items-center py-3 border-b last:border-b-0 hover:bg-gray-50">
                      ...
                      <div className="flex-1 grid gap-0 text-sm" style={{gridTemplateColumns: '1.8fr 1fr 1fr 1fr 1fr 1fr 1.2fr 1.3fr'}}>
                        ...
                        <div className="truncate text-left text-ellipsis overflow-hidden pl-1" title={user.company}>{user.company}</div>
                        <div className="truncate text-left text-ellipsis overflow-hidden pl-1" title={user.specialty}>{user.specialty}</div>
                        <div className="flex items-center text-left space-x-2 pl-1">
