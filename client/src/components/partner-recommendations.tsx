  ...
  return (
    <div className="space-y-6">
      ...
      <Dialog open={isLoadingAI} onOpenChange={() => {}}>
        <DialogContent className="w-[85vw] max-w-sm sm:max-w-lg lg:max-w-xl bg-white border-2 border-gray-200 shadow-2xl rounded-[7px] mx-auto">
          ...
          <div className="text-center py-4 sm:py-8 px-2 sm:px-4">
            <div className="space-y-3 sm:space-y-4">
              ...
              <div className="text-sm sm:text-base text-gray-700 whitespace-nowrap">
                잠시만 기다려 주세요...!
              </div>
            </div>
          </div>
