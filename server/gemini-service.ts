...
export class GeminiService {
  ...
  async analyzeSpecialtyAndRecommendSynergies(specialty: string): Promise<{
    ...
    try {
      // 원래 상세 분석 형식 유지, 속도만 최적화
      const prompt = `당신은 BNI 한국의 전문 비즈니스 네트워킹 분석가입니다. "${specialty}" 전문분야에 대한 체계적인 분석을 다음 형식으로 작성해주세요:

# ${specialty} 전문분야 BNI 네트워킹 분석

## 🏢 핵심 역량 분석
${specialty} 전문가의 주요 업무와 핵심 역량을 분석하고, 한국 시장에서의 역할과 직면한 과제 및 기회를 설명해주세요.

## 🤝 시너지 창출 비즈니스 분야  
${specialty}와 협업할 수 있는 다양한 비즈니스 분야들을 제시하고, 각각의 협업 방안과 시너지 효과를 구체적으로 설명해주세요.

## 🎯 시간대별 협업 전략

### 단기 협업 (즉시~6개월)
즉각적인 성과를 기대할 수 있는 협업 분야들을 제시하세요.

### 중기 협업 (6개월~2년)  
지속적인 관계 구축과 상호 성장을 위한 전략적 협업 분야들을 제시하세요.

### 장기 협업 (2년 이상)
혁신과 사업 확장을 위한 장기적 파트너십 분야들을 제시하세요.

## 💡 실행 방안
실제 네트워킹과 협업을 위한 구체적이고 실용적인 실행 방안들을 제시해주세요.

한국 비즈니스 환경에 맞는 실용적인 분석을 800-1000자로 작성해주세요.`;
