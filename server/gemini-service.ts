...
export class GeminiService {
  ...
  async analyzeSpecialtyAndRecommendSynergies(specialty: string): Promise<{
    ...
    try {
      // 이전의 상세한 4섹션 구조 형식으로 완전 복구
      const prompt = `당신은 BNI(Business Network International) 한국 지부의 전문 비즈니스 네트워킹 컨설턴트입니다. "${specialty}" 전문분야에 대한 포괄적이고 심층적인 비즈니스 시너지 분석을 수행해주세요.

다음 4개 섹션으로 구성된 체계적인 분석을 제공해주세요:

# ${specialty} 전문분야 비즈니스 네트워킹 심층 분석

## 🏢 핵심 역량 및 시장 포지셔닝 분석
${specialty} 전문가가 보유한 핵심 역량, 전문 지식, 서비스 범위를 상세히 분석하고, 한국 시장에서의 역할과 가치 창출 방식을 설명해주세요. 또한 이 전문분야가 직면한 주요 비즈니스 과제와 기회도 포함해주세요.

## 🤝 시너지 창출 가능 비즈니스 분야 및 협업 전략
${specialty}와 상호 보완적 관계를 형성할 수 있는 다양한 비즈니스 분야들을 상세히 분석해주세요. 각 분야별로:
- 구체적인 협업 방안
- 예상되는 시너지 효과  
- 상호 의존성 및 가치 교환 구조
- 실제 협업 사례나 모델
...
다음과 같이 단계별 협업 전략을 구체적으로 제시해주세요:

**즉시 실행 가능한 단기 협업 (0-6개월):**
실행이 용이하고 즉각적인 성과를 기대할 수 있는 협업 분야

**안정적 성장을 위한 중기 협업 (6개월-2년):**
지속적인 관계 구축과 상호 성장을 위한 전략적 협업 분야

**장기 비전 실현을 위한 협업 (2년 이상):**
혁신과 사업 확장을 위한 장기적 파트너십 구축 분야

## 💡 비즈니스 시너지 극대화 및 실행 방안
위에서 제시한 협업 전략을 실제로 실행하기 위한 구체적이고 실용적인 방안들을 제시해주세요. 여기에는 네트워킹 방법, 관계 구축 전략, 상호 이익 창출 모델 등이 포함되어야 합니다.

한국의 비즈니스 문화와 BNI 네트워킹의 특성을 충분히 반영하여, 실제 적용 가능한 전문적이고 실용적인 분석을 800-1000자 내외로 상세하게 제공해주세요.`;
