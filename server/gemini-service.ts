      ...
      sections: [
        {
          icon: '🏢',
          title: '핵심 역량 및 시장 포지셔닝 분석',
          content: `${specialty} 전문가는 해당 분야의 전문 지식과 경험을 바탕으로 고객에게 특화된 서비스를 제공합니다. 한국 시장에서의 위치를 분석하면, 지속적인 성장과 혁신을 통해 경쟁력을 유지하고 있으며, 고객 만족도 향상과 서비스 품질 개선에 중점을 두고 있습니다.`
        },
        {
          icon: '🤝', 
          title: '시너지 창출 가능 비즈니스 분야 및 협업 전략',
          content: `${specialty} 분야는 다양한 업종과의 협업을 통해 상호 발전할 수 있는 기회가 많습니다. 특히 마케팅, 브랜딩, 디자인, 제조업, 서비스업 등과의 협력을 통해 새로운 비즈니스 모델을 창출하고, 고객 기반을 확대할 수 있습니다.`
        },
        {
          icon: '🎯',
          title: '시간대별 협업 우선순위 및 실행 로드맵', 
          content: `단기적으로는 즉각적인 성과를 기대할 수 있는 협업 분야에 집중하고, 중기적으로는 지속적인 관계 구축과 상호 성장을 위한 전략적 파트너십을 개발합니다. 장기적으로는 혁신과 사업 확장을 위한 새로운 협업 모델을 구축합니다.`
        },
        {
          icon: '💡',
          title: '비즈니스 시너지 극대화 및 실행 방안',
          content: `BNI 네트워킹을 통한 체계적인 관계 구축, 정기적인 비즈니스 미팅, 상호 추천 시스템 활용, 공동 마케팅 프로젝트 추진 등을 통해 실질적인 비즈니스 성과를 창출할 수 있습니다.`
        }
      ]
    };

    return `# ${analysisTemplate.title}

## ${analysisTemplate.sections[0].icon} ${analysisTemplate.sections[0].title}

${analysisTemplate.sections[0].content}

## ${analysisTemplate.sections[1].icon} ${analysisTemplate.sections[1].title}

${analysisTemplate.sections[1].content}

## ${analysisTemplate.sections[2].icon} ${analysisTemplate.sections[2].title}

${analysisTemplate.sections[2].content}
...
${analysisTemplate.sections[3].content}
