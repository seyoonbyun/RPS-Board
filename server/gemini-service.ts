...
# ${specialty} 전문분야 BNI 네트워킹 분석

## 🏢 핵심 역량 및 시장 포지셔닝 분석
${specialty} 전문가가 보유한 핵심 역량, 전문 지식, 서비스 범위를 분석하고, 한국 시장에서의 역할과 가치 창출 방식을 설명해주세요. 이 전문분야가 직면한 주요 비즈니스 과제와 기회도 포함해주세요.

## 🤝 시너지 창출 가능 비즈니스 분야
${specialty}와 상호 보완적 관계를 형성할 수 있는 다양한 비즈니스 분야들을 분석해주세요. 각 분야별로 구체적인 협업 방안, 예상되는 시너지 효과, 상호 의존성 및 가치 교환 구조를 설명해주세요.

## 🎯 시간대별 협업 우선순위 및 실행 로드맵

### 즉시 실행 가능한 단기 협업 (0-6개월)
실행이 용이하고 즉각적인 성과를 기대할 수 있는 협업 분야들을 제시해주세요.

### 안정적 성장을 위한 중기 협업 (6개월-2년)
지속적인 관계 구축과 상호 성장을 위한 전략적 협업 분야들을 제시해주세요.

### 장기 비전 실현을 위한 협업 (2년 이상)
혁신과 사업 확장을 위한 장기적 파트너십 구축 분야들을 제시해주세요.

## 💡 비즈니스 시너지 극대화 방안
위에서 제시한 협업 전략을 실제로 실행하기 위한 구체적이고 실용적인 방안들을 제시해주세요. 네트워킹 방법, 관계 구축 전략, 상호 이익 창출 모델 등을 포함해주세요.

한국의 비즈니스 문화와 BNI 네트워킹 특성을 반영하여 실용적인 분석을 800-1000자로 작성해주세요.`;
